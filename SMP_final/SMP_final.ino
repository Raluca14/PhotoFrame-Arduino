...
// void bmpDrawPink(char *filename, uint8_t x, uint16_t y) {
...
// void bmpDrawBlackAndWhite(char *filename, uint8_t x, uint16_t y) {
...
// void bmpDrawIcey(char *filename, uint8_t x, uint16_t y) {
